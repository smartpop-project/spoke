...
export default class EmptyFrameNode extends EditorNodeMixin(Object3D) {
  static componentName = "empty-frame";

  static nodeName = "Empty Frame";
  ...
  static async deserialize(editor, json) {
    ...
    const mediaFrame = json.components.find(c => c.name === "empty-frame");
  ...
  prepareForExport() {
    ...
    this.remove(this.helper);
    this.addGLTFComponent("empty-frame", {
      mediaType: this.mediaType,
